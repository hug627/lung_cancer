...
.hero-stats {
    ...
    gap: 3rem; margin-top: 2rem; flex-wrap: wrap;
}
.hero-stat { text-align: center; }
.hero-stat-number {
    font-size: 2rem; font-weight: 700;
    color: #5dade2; display: block; line-height: 1;
}
.hero-stat-label {
...
.stButton > button {
    ...
    border-radius: 12px !important; padding: 0.9rem 2.5rem !important;
...
.dot-online { background: #2ecc71; box-shadow: 0 0 6px #2ecc71; animation: pulse 2s infinite; }
...
.section-label {
    ...
    color: #5dade2; margin-bottom: 0.5rem;
}
.section-title {
    font-family: 'Playfair Display', serif;
    font-size: 1.8rem; font-weight: 700;
    color: #ffffff; margin-bottom: 1rem; line-height: 1.3;
}
.section-body { color: #94a3b8; line-height: 1.8; font-size: 0.95rem; }
...
.feature-icon { font-size: 1.6rem; margin-bottom: 0.7rem; display: block; }
.feature-name { font-size: 0.9rem; font-weight: 600; color: #e2e8f0; margin-bottom: 0.3rem; }
...
.timeline::before {
    ...
    width: 1px; background: linear-gradient(to bottom, #3498db, transparent);
}
.timeline-step { position: relative; padding: 0 0 1.8rem 1.5rem; }
.timeline-step::before {
    content: ''; position: absolute;
    left: -1.4rem; top: 0.35rem;
    width: 10px; height: 10px; border-radius: 50%;
    background: #3498db; box-shadow: 0 0 8px rgba(52,152,219,0.5);
}
.timeline-step-title { font-weight: 600; color: #e2e8f0; font-size: 0.92rem; margin-bottom: 0.25rem; }
.timeline-step-body { font-size: 0.82rem; color: #64748b; line-height: 1.6; }
...
.impact-title { font-size: 0.85rem; font-weight: 600; color: #5dade2; margin-bottom: 0.4rem; }
...
.model-tag {
    ...
    color: #5dade2; font-size: 0.78rem; font-weight: 500;
    padding: 0.3rem 0.8rem; border-radius: 6px; margin: 0.2rem;
}
...
.disclaimer-box {
    ...
    color: #e2e8f0; font-size: 0.85rem; line-height: 1.7;
}
.about-box {
...
# ── CTA BUTTON — takes user to prediction page ─────────────────────────────
...
<div class="section-card">
  ...
  <div class="feature-grid">
    <div class="feature-card"><span class="feature-icon">🚬</span><div class="feature-name">Smoking</div><div class="feature-desc">History of tobacco use — the strongest known risk factor for lung cancer.</div></div>
    <div class="feature-card"><span class="feature-icon">🖐️</span><div class="feature-name">Yellow Fingers</div><div class="feature-desc">Nicotine staining — a visible marker of long-term heavy smoking.</div></div>
    <div class="feature-card"><span class="feature-icon">😰</span><div class="feature-name">Anxiety</div><div class="feature-desc">Chronic anxiety linked to stress-related immune suppression.</div></div>
    <div class="feature-card"><span class="feature-icon">👥</span><div class="feature-name">Peer Pressure</div><div class="feature-desc">Social influence leading to adoption of harmful habits.</div></div>
    <div class="feature-card"><span class="feature-icon">🏥</span><div class="feature-name">Chronic Disease</div><div class="feature-desc">Pre-existing conditions that may interact with cancer risk.</div></div>
    <div class="feature-card"><span class="feature-icon">😴</span><div class="feature-name">Fatigue</div><div class="feature-desc">Persistent exhaustion — a common early oncological symptom.</div></div>
    <div class="feature-card"><span class="feature-icon">🤧</span><div class="feature-name">Allergy</div><div class="feature-desc">Chronic allergic responses affecting respiratory health.</div></div>
    <div class="feature-card"><span class="feature-icon">💨</span><div class="feature-name">Wheezing</div><div class="feature-desc">Whistling breath indicating airway obstruction or narrowing.</div></div>
    <div class="feature-card"><span class="feature-icon">🍺</span><div class="feature-name">Alcohol Consuming</div><div class="feature-desc">Regular alcohol use as a compounding lifestyle risk factor.</div></div>
    <div class="feature-card"><span class="feature-icon">🫁</span><div class="feature-name">Coughing</div><div class="feature-desc">Persistent cough — one of the most common lung cancer signals.</div></div>
    <div class="feature-card"><span class="feature-icon">😮‍💨</span><div class="feature-name">Shortness of Breath</div><div class="feature-desc">Dyspnea indicating reduced lung capacity or obstruction.</div></div>
    <div class="feature-card"><span class="feature-icon">🍽️</span><div class="feature-name">Swallowing Difficulty</div><div class="feature-desc">Dysphagia — may indicate tumour pressure on the oesophagus.</div></div>
    <div class="feature-card"><span class="feature-icon">💔</span><div class="feature-name">Chest Pain</div><div class="feature-desc">Persistent chest discomfort — a key clinical warning sign.</div></div>
  </div>
</div>
""", unsafe_allow_html=True)
...
<div class="section-card">
  ...
  <div class="timeline">
    ...
    <div class="timeline-step">
      ...
      <div class="timeline-step-body">A fast, free, symptom-based risk signal that prompts earlier clinical consultation — before expensive diagnostics are needed.</div>
    </div>
    <div class="timeline-step">
...
<div class="section-card">
  ...
  <div class="section-body">
    The model is deployed via a <strong style="color:#5dade2">FastAPI backend on Hugging Face Spaces</strong>. 
...
<div class="section-card">
  ...
  <div class="impact-grid">
    <div class="impact-card"><div class="impact-icon">🎯</div><div class="impact-title">Earlier Detection</div><div class="impact-body">Flag high-risk patients before symptoms become severe.</div></div>
    <div class="impact-card"><div class="impact-icon">💰</div><div class="impact-title">Lower Costs</div><div class="impact-body">Symptom-based screening before expensive imaging procedures.</div></div>
    <div class="impact-card"><div class="impact-icon">⏱️</div><div class="impact-title">Faster Triage</div><div class="impact-body">Instant risk scores to help clinicians prioritise queues.</div></div>
    <div class="impact-card"><div class="impact-icon">📊</div><div class="impact-title">Research Insights</div><div class="impact-body">Surface patterns between lifestyle factors and cancer diagnosis.</div></div>
    <div class="impact-card"><div class="impact-icon">❤️</div><div class="impact-title">Save Lives</div><div class="impact-body">Earlier intervention leads to better treatment outcomes.</div></div>
  </div>
</div>
""", unsafe_allow_html=True)
...
<div class="disclaimer-box">
  ...
  professional. If you are experiencing symptoms, seek medical attention immediately.
</div>
<div class="about-box">
